...
const Sidebarpersonal = ({ bgcolor }) => {
  ...
  const menu = [
    ...
    },
    {
      ...
      title: " Professional",
      icon1: <BsMailbox />,
      option1: "Browser Professional",
      link1: "browser-professional",
      icon2: <BsFillCartFill />,
      option2: "View Professional",
      link2: "view-professional",
    },
    {
      id: 3,
      icon: <BsFillPersonFill />,
      title: "Notifications",
      mainlink: "/personal/notifications",
      slide: { handleSlide },
    },
    {
      id: 4,
              ...
              <div>
                <Menu.Button className="inline-flex space-x-2 item-center justify-center w-full my-auto rounded-md bg-transparent  pr-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                  <div className="rounded-full w-10 h-10">
                    <img src="/assets/images/personal-main.png" alt="dp" />
                  </div>{" "}
      ...
      >
        <div className="relative">
          <div className="h-full  ">
            <div className="flex justify-center bg-primary fixed w-full py-5 px-6">
              <img
