...
const ListPage = () => {
    ...
    return (
        <>
            <div className="container mx-auto pb-10 md:pt-24">
                                            ...
                                            >
                                                <div className="">
                                                    ...
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        <Link to="/employee-detail"> <div className="text-center font-s-bold text-base text-primary">{item.profile}</div> </Link>
                                                    </div>
