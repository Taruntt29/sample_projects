        ...
        <div className="shadow-box bg-white">
          <div className="grid grid-cols-1 md:grid-cols-2 shadowsignup">
            <div className=" h-full container mx-auto px-3 md:px-10 py-16">
              ...
              <form className="flex justify-start w-full gap-3 flex-col" autocomplete="off">
                {" "}
                ...
                <div className="flex justify-start flex-col gap-1 w-full mobileinput">
                  ...
                  <PhoneInput
                    ...
                    value={value}
                    onChange={() => setValue()}
                    className="w-full bg-inputcolor border-none focus:placeholder-gray-500 placeholder:text-[#000000] placeholder:text-opacity-30 placeholder:text-sm px-3 py-2 rounded-[7px]"
                  />
                </div>
                <div className="flex justify-start flex-col gap-1 w-full">
            ...
            <div
              ...
              style={{
                backgroundImage: `url(${"/assets/images/personal-signup.png"})`,
              }}
            ></div>
          </div>
        </div>
