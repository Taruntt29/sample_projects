...
const DashboardNavbar = ({ bgcolor }) => {
  ...
  const menu = [
    ...
    },
    {
      ...
      title: "Manage Jobs",
      mainlink: "/hospital/managed-jobs",
      slide: { handleSlide },
    },
    {
      id: 4,
...

    {
      ...
      mainlink: "/hospital/browse-candidate",
      slide: { handleSlide },
    },

    {
      ...
      icon: <GiRingingBell />,
      title: " Notifications",
      mainlink: "/hospital/notifications",
      slide: { handleSlide },
    },
    {
      id: 7,
    ...
    },
    {
      ...
      link1: "assistant-chat",
      icon2: <MdEmail />,
      option2: "Assistant Email",
      link2: "assistant-mail",
    },
    {
      id: 10,
  ...
  return (
    <div
      className={
        color || bgcolor
          ? "header bg-[#fff] z-50 pt-16 pb-12 duration-500"
          : "header bg-[#fff] z-50 pt-16 pb-12 duration-500"
      }
    >
        ...
        <div className="flex justify-end items-center w-full gap-3 md:gap-8  ">
          ...
          <div className="">
            <Menu as="div" className="relative inline-block text-left">
              <div>
                <Menu.Button className="inline-flex item-center justify-center space-x-2 w-full my-auto rounded-md bg-transparent  pr-4 py-2 text-sm font-medium text-white hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
                  <div className="rounded-full w-12 h-12">
                    <img src="/assets/images/companydp.png" alt="dp" />
                  </div>{" "}
      ...
      >
        <div className="relative">
          <div className="h-full  ">
            <div className="flex justify-start bg-primary fixed w-full py-5 px-6">
              <img
                        ...
                        <Link onClick={item.slide} to={item.mainlink}>
                          ...
                          >
                            <div className="flex items-center gap-3 px-3 py-2">
                              ...
                              <span className="font-s-normal group-hover:text-primary text-base">
                                {" "}
                                {item.title}
                              </span>{" "}
                            </div>
                              ...
                              {clicked === index ? (
                                <ul className="dropdown-acc list-disc  my-2 rounded">
                                  ...
                                  {item.option3 ? (
                                    ...
                                    >
                                      <div className="flex space-x-2 px-10 py-2 bg-transparent hover:bg-[#F5F7F9] text-white hover:text-grey rounded-l-md ">
                                        <span className="group-hover:text-primary">
                                          {" "}
                                          {item.icon3}{" "}
                                        </span>{" "}
