      ...
      <div className="bg-inputcolor  lg:px-0 px-5 pb-5">
        ...
        <div className="container mx-auto pt-5 pb-5 shadow-box mb-12 mt-5 rounded bg-white">
          <div className="flex space-x-4  px-5 pb-5">
            ...
            <h3 className="font-bold  text-lg font-s-medium flex justify-center items-center pt-1">
              Sent <BiChevronRight className="" size={32} />
            </h3>
          </div>
          ...
          {inboxdata.map((item) => (
            <div className="lg:grid grid-cols-12  border-gray-200 border-t-2 p-4 gap-2">
              ...
              <div className="col-span-9 flex justify-between">
                <div>
                  <Link to="/hospital/email-description">
                  ...
                  <div>
                    ...
                    >
                      <a href="/hospital/email-description">Reply</a>
                    </button>
                  </div>
                </div>
              </div>
...
export default SentMailsHospital;
