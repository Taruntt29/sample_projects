      ...
      <div className="container mx-auto pt-5  bg-white   rounded">
        ...
        <div className=" lg:px-8 px-5 py-8">
          ...
          <div className="shadow-box rounded-b-md ">
            ...
            <Link to="/professional/sent-mails">  <button className="px-16 bg-primary py-2 text-white font-s-medium rounded text-lg">
                Sent
              </button>
              </Link>
            </div>
...
export default ComposeHospitalEmail