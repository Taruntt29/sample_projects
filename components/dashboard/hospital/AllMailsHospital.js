    ...
    <>
      <div className="bg-inputcolor  lg:px-0 px-5 pb-5">
        <div className=" pt-12 lg:px-10  ">
          {" "}
          <div className=" mb-4 font-s-medium text-primary text-lg">
            <Link
              to="/hospital"
...
export default AllMailsHospital;
