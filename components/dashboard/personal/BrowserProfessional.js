...
const BrowserProfessional = () => {
    ...
    return (
        <>
            <div className=" bg-inputcolor py-16 mx-auto">
                <div className="container">
                    <Link to="/personal">
                        {" "}
                        <div className="flex items-center mb-4 font-s-medium text-primary text-lg">
                            <RiArrowLeftSLine className="text-3xl" /> Professional
                        </div>
                    </Link>
                </div>
                <div className="container bg-white rounded-lg grid lg:grid-cols-7 grid-cols-1 p-8 gap-4 pt-10">
                    <div className="lg:col-span-2 lg:px-0 px-5">
                        {/* edit mobile start */}
                        <div className="bg-slate-50 p-2 md:hidden block">
                            <button type="button" onClick={openModal} className="w-full flex items-center gap-2 justify-center">
                                <GiSettingsKnobs />
                        ...
                        <div className="bg-lightcolor p-5 rounded-lg md:block hidden">
                            ...
                            <div className="pb-7">
                                ...
                                <div className="flex pt-2 ">
                                    ...
                                    <div className=" py-3 lg:pr-3 pr-1   bg-white rounded-r-[3px]">
                                        <img src="/assets/images/location.png " className="pt-1" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="pb-5">
                                <p className="font-s-medium lg:text-lg text-base"> Date Post </p>
                            ...
                            <div className="pb-5">
                                <p className="font-s-medium lg:text-lg text-base"> Hospital Type </p>
                            ...
                            >
                                <div className=" bg-primary/50  h-[60vh] relative flex md:justify-center rounded-lg ">
                                    <div>
                                        ...
                                        <p className=" md:px-8 px-5 pt-5 text-white font-s-medium"> Get Best Matched Jobs On your Email. Add Resume NOW! </p>
                                        <div className="px-8 py-3">
                                            <button className="bg-white text-primary hover:bg-primary hover:text-white px-6 py-1 rounded-md"> Read More </button>
                                        </div>
                    ...
                    <div className="lg:col-span-5">
                                                ...
                                                <div className="">
                                                    ...
                                                    <div className="bg-primary rounded-b-xl py-3 lg:mt-4">
                                                        <div className="grid grid-cols-2 gap-2 px-3">
                                                            ...
                                                            <div className="flex justify-end text-white  text-sm">{item.cost} </div>
                        ...
                        <div className=" hidden md:flex items-center justify-center pt-16 bg-white px-4 py-3 sm:px-6">
                            ...
                            <div className=" flex  items-center justify-between">
                                ...
                                <div>
                                    <nav className="isolate inline-flex gap-2 -space-x-px rounded-md " aria-label="Pagination">
                                        <a
                                            href="#"
...
export default BrowserProfessional