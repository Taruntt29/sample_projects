...
import { BsFillBagFill, BsFillHandbagFill } from "react-icons/bs";
import {
  FaFacebookF,
  FaInstagram,
  FaTwitter,
    ...
    <div>
      <div className="bg-inputcolor py-16">
        <div className="mx-auto max-w-[1150px]">
          <Link to="/professional/browse-hospital">
            {" "}
            <div className="flex items-center mb-4 font-s-medium text-primary text-lg">
              <RiArrowLeftSLine className="text-3xl" /> Candidate
            </div>
          </Link>
          ...
          <div className="bg-[#fff] px-8 rounded-2xl py-6">
            <div className="flex pb-8 items-center text-[#000] space-x-4 font-s-medium text-xl">
              ...
              <h6 className="text-2xl"> Candidate Detail</h6>
            </div>
            <hr className="mb-8" />
            <div className="">
              <div className="container mx-auto md:pb-20 ">
                <div className=" grid lg:grid-cols-7 grid-cols-1 gap-8">
                  <div className="lg:col-span-5 px-5 md:px-0">
                    <div
                      className="rounded-md bg-no-repeat bg-primary relative h-80 bg-cover w-full"
                      style={{
                    ...
                    >
                      ...
                      <div className="absolute md:bottom-5 bottom-2 w-full px-3 ">
                        <div className="flex items-end justify-between  gap-2  ">
                          ...
                          <div>
                            <button className="text-sm bg-white  text-primary font-s-medium  px-10 py-2 rounded-md shadow-sm shadow-slate-700 ">
                              Download CV
                            </button>
                          </div>
                        </div>
                    ...
                    <div className="font-s-bold py-8 text-xl">
                      Education & Training
                    </div>
                    <div className=" border border-primary rounded-md px-5 py-6">
                      <div className="grid grid-cols-1  mx-auto  gap-3 items-center justify-items-start ">
                      ...
                      <div className="pt-10 flex flex-col justify-start items-start gap-6">
                        ...
                        <div className="flex justify-start items-center gap-3 px-3 ">
                          ...
                          <div className="">
                            ...
                            <p className=" font-s-bold text-base "> 4 Years </p>
                          </div>
                        </div>
                        ...
                        <div className="flex justify-start items-center gap-3 px-3 ">
                          ...
                          <div className="">
                            ...
                            <p className="font-s-bold text-[14px]">
                        ...
                        <div className=" bg-primary/50  h-[60vh] relative flex md:justify-center rounded-lg ">
                          <div>
                            ...
                            <p className=" md:px-8 px-5 pt-5 text-white ">
                              {" "}
                              Get Best Matched Jobs On your Email. Add Resume
                              NOW!{" "}
                            </p>
