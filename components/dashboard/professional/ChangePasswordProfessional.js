...
const ChangePasswordProfessional = () => {
          ...
          <div className=" py-16">
            <div className="">
              <Link to="/professional">
                {" "}
                <div className="flex container mx-auto  mb-4 font-s-medium text-primary text-lg lg:px-16 ">
...
export default ChangePasswordProfessional;
