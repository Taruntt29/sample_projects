...
const EmailProfessionalDescription = () => {
  ...
  return (
    <div className="bg-inputcolor">
      <div className="container mx-auto py-10">
        <Link to="/professional/all-mails">
          {" "}
          <div className="flex space-x-2 items-center pb-6 lg:px-0 px-5 ">
            {" "}
            <RiArrowLeftSLine className="text-primary w-5 h-5 " />{" "}
            <p className="text-primary font-s-medium text-base"> Email</p>{" "}
          </div>{" "}
        </Link>
...
export default EmailProfessionalDescription;
