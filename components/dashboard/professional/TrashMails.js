  ...
  return (
    <>
      <div className="bg-inputcolor  lg:px-0 px-5 pb-5">
        ...
        <Link to="/professional/all-mails" >  <h3 className="font-bold  text-lg  pt-1 text-primary flex items-center ">
        ...
        <div className="container mx-auto pt-5 pb-5 shadow-box mb-12 mt-7 rounded bg-white ">
            ...
            <h3 className="font-bold  text-lg font-s-medium flex pt-1">
